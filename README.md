...
O MongoDB é executado como um **Replica Set de nó único** (configuração recomendada para uso com Prisma).

```bash
# Subir os serviços
docker compose up -d

# Inicializar o Replica Set automaticamente (execute apenas na primeira vez)
