...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Notebook', description: 'Nome do produto' }),
    __metadata("design:type", String)
], CreatePedidoDto.prototype, "produto", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 2, description: 'Quantidade do pedido' }),
    __metadata("design:type", Number)
], CreatePedidoDto.prototype, "quantidade", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'pendente', description: 'Status do pedido', required: false }),
    __metadata("design:type", String)
